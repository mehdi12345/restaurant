...
import 'package:restaurant/widgets/icon_and_text.dart';
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  SmallText(
                                      text: "With Chinese characteristique"),
                                  SizedBox(
                                    height: Dimensions.height10,
                                  ),
                                  Row(
  ...
  Widget _buildPageItem(int index) {
    ...
    if (index == _currPageValue.floor()) {
      ...
      var currScale =
          _scaleFactor + (_currPageValue - index - 1) * (1 - _scaleFactor);
      var currTrans = _height * (1 - currScale) / 2;
      matrix = Matrix4.diagonal3Values(1, currScale, 1.9)
        ..setTranslationRaw(0, currTrans, 0);
    } else {
      var currScale = 0.8;
      var currTrans = _height * (1 - currScale) / 2;
